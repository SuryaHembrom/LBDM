...
#reduced2.gset <- log2(ttbh.transpose.counts_GeTMM.filt[gf1,])
```{r}
...
## THIS METHOD OF BORUTA ON TRAINING SET INCREASES THE NUMBER OF RUNS NEEDED TO SELECT THE IMPORTANT FEATURES ## AND HENCE MAKES THE 
...
# for estimation of accuracy of model on test data 
...
# full dataset randomforest : no train and test split
...
# normal fallopian tube: control condition 
...
# omental tumor: disease condition
